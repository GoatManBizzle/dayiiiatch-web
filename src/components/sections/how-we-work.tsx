...
export default function HowWeWorkSection() {
  return (
    <section className="relative mt-12 overflow-hidden rounded-[1.7rem] border border-white/10 bg-white/[0.035] p-5 shadow-[0_0_52px_rgba(139,92,246,0.07)] backdrop-blur-xl sm:rounded-[2rem] sm:p-6 md:mt-16 md:p-8">
