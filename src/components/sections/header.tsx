...
export default function HeaderSection() {
  ...
  return (
    <header className="sticky top-2 z-[760] mb-7 mt-4 flex justify-center transition-all duration-300 ease-out sm:top-3">
      <nav
        className={`flex w-full max-w-5xl flex-wrap items-center justify-center gap-1.5 rounded-[1.35rem] border px-2 py-2 backdrop-blur-xl transition-all duration-300 ease-out sm:w-auto sm:rounded-full sm:gap-2 ${
          scrolled
