...
export default function AboutSummarySection() {
  return (
    <section
      ...
      className="relative mt-8 overflow-hidden rounded-[1.5rem] border border-cyan-300/14 bg-zinc-950/58 p-4 shadow-[0_0_54px_rgba(34,211,238,0.08)] backdrop-blur-xl sm:rounded-[2rem] sm:p-6 md:mt-12 md:p-8"
    >
